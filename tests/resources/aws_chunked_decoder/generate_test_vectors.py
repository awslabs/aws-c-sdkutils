...
def main():
    ...
    for v in data["success_tests"]:
        ...
        name = escape_c_string(v["expect"]["trailer_name"])
        value = escape_c_string(v["expect"]["trailer_value"])
        ...
        print(f"        .expected_trailer_name = \"{name}\",")
        print(f"        .expected_trailer_value = \"{value}\",")
